...
|--------------------------------------------+----------+-----+-------------+-------|
| `basic` (sort-fn: off)                     | 0.055542 |   0 |    0.000000 |  1.00 |
| `fussy` / `fzf-score` / `default` (off)    | 0.105458 |   0 |    0.000000 |  1.90 |
| `fussy` / `fzf-score` / `by-scoring` (off) | 0.112884 |   0 |    0.000000 |  2.03 |
| `hotfuzz` (sort-fn: off)                   | 0.114577 |   0 |    0.000000 |  2.06 |
| `orderless` + `flex` (off)                 | 0.313757 |   0 |    0.000000 |  5.65 |
| `orderless` (off)                          | 0.313872 |   0 |    0.000000 |  5.65 |
| `fussy` / `fuz-bin` (on)                   | 0.517608 |   0 |    0.000000 |  9.32 |
| `substring` (off)                          | 0.782506 |   0 |    0.000000 | 14.09 |
| `fussy` / `flx` (on)                       | 1.040492 |   2 |    0.149982 | 18.73 |
| `flex` (off)                               | 2.187291 |   0 |    0.000000 | 39.38 |
| `fussy` / `flx-rs` (on)                    | 4.009710 |   0 |    0.000000 | 72.19 |
